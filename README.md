...
Name                                   | Description                                                                          | Mandatory | Default | Example
-------------------------------------- |--------------------------------------------------------------------------------------| --------- | ------- | ----------------------------------------
ACCOUNTS_API_PORT                      | Appication Port                                                                      | ✓         |         | 12345
AWS_SECRET_ACCESS_KEY                  |                                                                                      | ✓         |         | wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY
AWS_ACCESS_KEY_ID                      |                                                                                      | ✓         |         | AKIAIOSFODNN7EXAMPLE
IMAGE_CLOUD_S3_PATH                    |                                                                                      | ✓         |         | s3://xxx/xxxx/xxxx
REGION_NAME_FOR_AMAZON_S3              |                                                                                      | ✓         |         | xx-region-xx
...
MONGODB_DATABASE                       | MongoDB Transactions Database name.                                                  | ✓         |         | accounts_validator
...
### Direct Felix validation
```
  POST
  http://localhost:18624/direct_file_validate
  body: file attached
```
